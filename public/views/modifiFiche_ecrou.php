...
<div class="container mt-5">
  ...
  <form  method="POST" id="form">
    ...
    <div class="row mb-3">
      <div class="col-md-4">
        <label for="role" class="form-label">Langues</label>
        <select id="langue" multiple name="langue[]" class="form-select"  required>
          <option value="Français">Français</option>
          <option value="Wolof">Wolof</option>
          <option value="Anglais">Anglais</option>
          <option value="Diola">Diola</option>
          <option value="Soninké">Soninke</option>
          <option value="Mancagne">Mancagne</option>
        </select>
      </div>
      <div class="col-md-4">
        <div class="mb-3">
            <label for="role" class="form-label">Niveau instruction</label>
...
<script src="front_js/modifi_fiche_ecrou.js"></script>
